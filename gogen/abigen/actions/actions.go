...
// AddPlayer is a paid mutator transaction binding the contract method 0x5076c06b.
//
// Solidity: function addPlayer((uint16,uint16,uint8,uint8,uint16,uint16,uint8,uint8,uint16,uint16,uint8) action) returns()
