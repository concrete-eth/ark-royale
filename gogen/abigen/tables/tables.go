...
//
// Solidity: function getUnitPrototypesRow(uint8 unitType) view returns((uint8,uint16,uint8,uint8,uint8,uint8,uint8,uint8,uint8,uint8,bool,bool,bool))
