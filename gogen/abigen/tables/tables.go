...
//
// Solidity: function getPlayersRow(uint8 playerId) view returns((uint16,uint16,uint8,uint8,uint16,uint16,uint8,uint8,uint16,uint16,uint16,uint16,uint8,uint8,uint8,uint8,uint8,uint8,uint8,uint8,uint8))
